...
function stopAnimation(){
    document.getElementById("fountainG").innerHTML="";
}

function startAnimation(){
    $("#fountainG").append('<div id="fountainG_1" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_2" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_3" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_4" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_5" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_6" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_7" class="fountainG"></div>');
    $("#fountainG").append('<div id="fountainG_8" class="fountainG"></div>');    
}